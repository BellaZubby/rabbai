    ...
    return (
      <section>
        <div className='w-full fixed z-[40]'>
          <div className='w-5/6 mx-auto bg-[#FFFFFF] shadow-lg flex items-center justify-center gap-9 rounded-md mt-6 p-3'>
            <Image src={logo} alt={"logo"}></Image>
            <div className='flex items-center gap-5 text-sm cursor-pointer'>
              ...
              <div className='flex items-center gap-1 text-sm'>
                ...
                <button className='bg-[#0086FF] px-12 py-1 rounded-lg text-white font-semibold'>Sign up</button>
              </div>
            </div>
          </div>
